...
const resolver = ref(
  zodResolver(
    z.object({
      ...
      email: z
        .string()
        .min(15, { message: 'Email is required.' })
...
<template>
  ...
  >
    <div
      class="border-x-green-500 color-danger-500 flex flex-col gap-8 justify-center items-center mt-11"
    >
      ...
      <Password v-model="password" placeholder="Пароль" fluid toggle-mask>
        <template #header>
